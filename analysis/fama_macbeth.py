...
def create_fama_macbeth_visualizations(
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_PLOTS_DIR, "gamma1_timeseries.png"), dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_PLOTS_DIR, "gamma1_histogram.png"), dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_PLOTS_DIR, "beta_vs_return_scatter.png"), 
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_PLOTS_DIR, "fama_macbeth_by_country.png"), 
                dpi=300, bbox_inches='tight')
    plt.close()

...
def create_capm_visualizations(results_df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    beta_hist_path = os.path.join(RESULTS_PLOTS_DIR, "beta_distribution_by_country.png")
    ...
    plt.tight_layout()
    alpha_hist_path = os.path.join(RESULTS_PLOTS_DIR, "alpha_distribution_by_country.png")
    ...
    plt.tight_layout()
    scatter_path = os.path.join(RESULTS_PLOTS_DIR, "beta_vs_r2_scatter.png")
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    boxplot_path = os.path.join(RESULTS_PLOTS_DIR, "beta_boxplot_by_country.png")
    ...
    plt.tight_layout()
    top_bottom_beta_path = os.path.join(RESULTS_PLOTS_DIR, "top_bottom_beta_stocks.png")
    ...
    plt.tight_layout()
    avg_beta_path = os.path.join(RESULTS_PLOTS_DIR, "average_beta_by_country.png")
...
def run_full_capm_analysis(panel_path: Optional[str] = None) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    print(f"   Plots: {RESULTS_PLOTS_DIR}/")
    print("="*70)

...
The analysis covers \textbf{7 European markets\textbf{: Germany (DE), France (FR), Italy (IT), Spain (ES), Sweden (SE), United Kingdom (UK), and Switzerland (CH). After data cleaning and quality filters, the final sample consists of \textbf{245 valid stocks\textbf{ (out of 249 total) with complete return data.

...
- **Significant betas** (p < 0.05) represent approximately 95.9% of the sample, indicating that for most stocks, beta is statistically distinguishable from zero.
...
- **Average $\gamma_1$ (market price of risk):** -0.9662
  - **t-statistic:** -1.199
  - **p-value:** 0.2356
  - **Interpretation:** NOT statistically significant at conventional levels (5% or 10%)

- **Average $\gamma_0$ (intercept):** 1.5385%
  - **t-statistic:** 4.444
  - **p-value:** 0.000040

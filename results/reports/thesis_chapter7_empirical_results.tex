...
The analysis covers \textbf{7 European markets\textbf{: Germany (DE), France (FR), Italy (IT), Spain (ES), Sweden (SE), United Kingdom (UK), and Switzerland (CH). After data cleaning and quality filters, the final sample consists of \textbf{245 stocks\textbf{ with complete return data.
...
- \textbf{Valid stocks:\textbf{ 245 (out of 249 total)
- \textbf{Average beta:\textbf{ 0.917
- \textbf{Median beta:\textbf{ 0.875
- \textbf{Average R²:\textbf{ 0.235
- \textbf{Average alpha:\textbf{ -0.099%
...
- \textbf{Significant betas\textbf{ (p < 0.05) represent approximately 91.4% of the sample, indicating that for most stocks, beta is statistically distinguishable from zero.
...
3. \textbf{Betas are plausible:\textbf{ The median beta of 0.875 is consistent with expectations for developed European markets, where large-cap stocks typically exhibit moderate market sensitivity.

4. \textbf{Positive alphas:\textbf{ The average alpha of -0.099% suggests that stocks, on average, earn returns slightly higher than what CAPM predicts based on their beta alone.
...
- \textbf{Average $\gamma_1$ (market price of risk):\textbf{ -0.5747
  - \textbf{t-statistic:\textbf{ -0.880
  - \textbf{p-value:\textbf{ 0.3825
  - \textbf{Interpretation:\textbf{ NOT statistically significant at conventional levels (5% or 10%)

- \textbf{Average $\gamma_0$ (intercept):\textbf{ 1.3167%
  - \textbf{t-statistic:\textbf{ 4.112
  - \textbf{p-value:\textbf{ 0.000125
...
- \textbf{$\gamma_0$ is strongly positive and significant\textbf{ → Even a zero-beta asset earns a positive excess return (approximately 1.32% per month), suggesting that the zero-beta rate exceeds the risk-free rate.
...
- \textbf{France:\textbf{ $\gamma_1 = -1.4224$ (t = -1.401) — borderline significant \textbf{negative\textbf{ pricing
- \textbf{Sweden:\textbf{ $\gamma_1 = -1.1308$ (t = -1.395) — also \textbf{negative\textbf{

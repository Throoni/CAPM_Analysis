...
| Optimal Risky (Tangency, Unconstrained) | 304.02 |  Theoretical | Unrealistic (expected) |
...
-  Minimum-Variance (Unconstrained): 0.0054% - Unrealistically low (theoretical)
-  Optimal Risky (Tangency, Constrained): 2.34% - Reasonable
-  Optimal Risky (Tangency, Unconstrained): 0.079% - Unrealistically low (theoretical)
